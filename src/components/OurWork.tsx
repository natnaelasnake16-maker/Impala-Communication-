...
const caseStudies: CaseStudy[] = [
  ...
  {
    client: "Africa Cocoa Finance & Investment Forum (ACFIF)",
    tag: "Finance & Investment Communications",
    logoUrl: brandMarks.acfif,
    fallback: "ACFIF",
    challenge: "Position Africa's cocoa story within global finance and investment conversations.",
    approach: "Leading strategic communications, positioning, and stakeholder engagement across New York, Amsterdam, and Accra.",
    outcome: "Strengthening ACFIF's profile as a platform for investment, dialogue, and collaboration across Africa's cocoa sector.",
  },
  {
    client: "Michu Clinic",
